...
var deleteFolderRecursive = function(removePath) {
  if( fs.existsSync(removePath) ) {
    ...
    process.stdout.write('Removing SASS Folder: ' + removePath);
  }
};
...
var windowsPlatformsDir = path.resolve(__dirname, '../../platforms/windows/www/lib/ionic/scss');

deleteFolderRecursive(iosPlatformsDir);
deleteFolderRecursive(androidPlatformsDir);
deleteFolderRecursive(windowsPlatformsDir);
